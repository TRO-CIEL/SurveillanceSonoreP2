...
// Implémentation du filtre de pondération A
void CSon::applyAWeighting(double* signal, double* output, size_t longueur) {
    ...
    // Variables pour les valeurs précédentes du filtre
